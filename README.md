## Hi, I'm Ali 👋  
Software Engineer | React Native Engineer | AI-Enabled Product Builder | Scalable Products  

- 9+ years experience in Web, Mobile & ERP Systems  
- Working on AI-powered insights & automation tools  
...
Import / Export & Finance ERP with AI implementation. 
Automated their manual work. Saved 100x time. 
Suggestions on business insights.
Roles Management

**Xenia**
Automated Task Management.
Modern and user-friendly layouts.
QR and Payments implementation
Offline Mode.
Checklists creation based on routine.
User Role

**Aaghaz Investments**
Investment Plans for Muslims
AI questionnaire based on user profile
Suggestions to invest in a specific domain and company based on the user profile
